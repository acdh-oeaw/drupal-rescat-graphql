...
/**
 * @DataProducer(
 *   id = "query_project_statuses",
 *   name = @Translation("Load Project Statuses"),
 *   description = @Translation("Loads a list of Project Statuses."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("Project Statuses")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QueryProjectStatuses extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
    ...
    public function resolve($offset, $limit, $name, RefinableCacheableDependencyInterface $metadata) {
        ...
        $query->condition($type->getKey('bundle'), 'project_statuses');
        if ($name) {
