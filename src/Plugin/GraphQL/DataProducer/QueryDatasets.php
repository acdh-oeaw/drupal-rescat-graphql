 ...
 * @DataProducer(
 *   id = "query_datasets",
 *   name = @Translation("Load datasets"),
 *   description = @Translation("Loads a list of datasets."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("Dataset connection")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QueryDatasets extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
