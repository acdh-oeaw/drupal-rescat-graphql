 ...
 * @DataProducer(
 *   id = "delete_project",
 *   name = @Translation("Delete Project"),
 *   description = @Translation("Delete Project."),
 ...
 * )
 */
class DeleteProject extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
