...
/**
 * @DataProducer(
 *   id = "query_identifier_services",
 *   name = @Translation("Load Identifier Services"),
 *   description = @Translation("Loads a list ofIdentifier Services."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("IdentifierServices relations")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QueryIdentifierServices extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
    ...
    /**
     * IdentifierServices constructor.
     *
    ...
    public function resolve($offset, $limit, $name, RefinableCacheableDependencyInterface $metadata) {
        ...
        $query->condition($type->getKey('bundle'), 'identifier_services');
        if ($name) {
