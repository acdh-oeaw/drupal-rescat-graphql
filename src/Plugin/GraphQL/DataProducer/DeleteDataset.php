 ...
 * @DataProducer(
 *   id = "delete_dataset",
 *   name = @Translation("Delete Dataset"),
 *   description = @Translation("Delete Dataset."),
 ...
 * )
 */
class DeleteDataset extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
