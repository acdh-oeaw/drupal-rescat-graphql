...
/**
 * @DataProducer(
 *   id = "query_person_relations",
 *   name = @Translation("Load person relations"),
 *   description = @Translation("Loads a list of person relations."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("Person relations connection")
 *   ),
 *   consumes = {
